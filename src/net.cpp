...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SESAME " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"SESAMEtools.com", "dnsseed.SESAMEtools.com"},
    {"SESAMEpool.org", "dnsseed.SESAMEpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"SESAMEtools.com", "testnet-seed.SESAMEtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SESAME is probably already running."), addrBind.ToString().c_str());
        else
